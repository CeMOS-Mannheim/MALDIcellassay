...
Briefly, cells were treated with the following concentration of a compound: 0, 0.04, 0.12, 0.37, 1.11, 3.33, 10, 30 µM.
After incubation the cells were washed, transferred to a MALDI target plate and matrix was applied.
For each concentration a 4 spots were applied which means that we also have 4 "measurement replicates" for each concentration.
